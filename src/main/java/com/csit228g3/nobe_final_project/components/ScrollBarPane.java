 ...
 */
package com.csit228g3.nobe_final_project.components;
 ...
 * @author Raven
 */
public class ScrollBarPane extends JScrollPane {

    public ScrollBarPane() {
        getVerticalScrollBar().setUI(new com.csit228g3.nobe_final_project.components.ScrollBar());
        getHorizontalScrollBar().setUI(new com.csit228g3.nobe_final_project.components.ScrollBar());
